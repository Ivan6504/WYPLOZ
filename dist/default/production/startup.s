	...
	; -Mdist/default/production/WIPLOZ.X.production.map \
	; -DXPRJ_default=default -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC16Fxxx_DFP/1.3.42/xc8 \
	; --opt=+asmfile --addrqual=ignore -P --warn=-3 --asmlist --std=c90 \
	; --output=+elf:multilocs --stack=compiled:auto:auto --summary=+xml \
	; --summarydir=dist/default/production/memoryfile.xml \
	; -oWIPLOZ.X.production.elf --objdir=dist/default/production \
	; --outdir=dist/default/production build/default/production/WIPLOZ.p1 \
	; build/default/production/PWM.p1 -L--fixupoverflow=error \
